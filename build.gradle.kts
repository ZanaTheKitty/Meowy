...
subprojects {
    ...
    aliucord {
        ...
        updateUrl.set("https://raw.githubusercontent.com/ZanaTheKitty/Meowy/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/ZanaTheKitty/Meowy/builds/%s.zip")
    }
